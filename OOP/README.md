...
The meaning of **Encapsulation**, is to make sure that "sensitive" data is hidden from users. To achieve this, you must:
  ...
  **Why Encapsulation?**
  ...
  [See more about Encapsulation](https://github.com/youosfkortam/CS-Knowledge-Hub/blob/main/OOP/Encapsulation.md)
...
```
  ...
  [See more about Abstraction](https://github.com/youosfkortam/CS-Knowledge-Hub/blob/main/OOP/Abstraction.md)
...
- It is useful for code reusability: reuse attributes and methods of an existing class when you create a new class.
  ...
  [See more about Inheritance](https://github.com/youosfkortam/CS-Knowledge-Hub/blob/main/OOP/Inheritance.md)
...
It is useful for code reusability: reuse attributes and methods of an existing class when you create a new class.
  ...
  [See more about Polymorphism](https://github.com/youosfkortam/CS-Knowledge-Hub/blob/main/OOP/Polymorphism.md)
